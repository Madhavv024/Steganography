...
⠀⠀⠀⠁⠁⠀⠁⠀⠀⠀⠀⠈⠀⠀⠀⠈⠉⠉⠋⠉⠉⠉⠉⠁⠉⠉⠀⠉⠈⠁⠉⠉⠛⠛⠋⠉⠉⠉⠉⠉⠉⠉⠉⠀⠈⠀⠀'''
    ...
    def main(self,root):
        ...
        b_encode = Button(f,text="Encoder",command= lambda :self.frame1_encode(f), padx=14)
        b_encode.config(font=('courier',14))
        b_decode = Button(f, text="Decoder",padx=14,command=lambda :self.frame1_decode(f))
    ...
    def frame2_decode(self,d_f2):
        ...
        if not myfile:
            ...
            l2 = Label(d_f3, text='Hidden data in the image :')
